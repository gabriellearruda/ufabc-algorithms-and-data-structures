...
# Usando m = 12, testa a função de divisão com valores de chave variando de 0 até 100. 
# Quando o resultado h(x) é igual a 3, imprime o valor de chave correspondente.
for i in range(0, 101):
    if hash.divisao(i, 12) == 3:
        print(i)

# Usando m = 11, testa a função de divisão com valores de chave variando de 0 até 100. 
# Quando o resultado h(x) é igual a 3, imprime o valor de chave correspondente.
for i in range(0, 101):
